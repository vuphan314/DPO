...
public:
  ...
  BucketElimPlanner(bool usingTreeClustering, Int clusterVarOrderHeuristic);
};
...
public:
  ...
  BouquetMethodPlanner(bool usingTreeClustering, Int clusterVarOrderHeuristic);
};
...
public:
  ...
  string helpClusteringHeuristic();
